...
(function (exports) {
  function generateFriendListByBabyStep(stepID, friends) {
    if (friends.length === 0) return "";else return makeFriends(friends) + " also in Baby Step " + stepID;
  }
  ...
  function makeMultiFriends(friends) {
    var otherFriendsCount = friends.length - 2;
    var friendPlural;
    if (otherFriendsCount > 1) friendPlural = "friends";else friendPlural = "friend";
  ...
  if (typeof exports !== "undefined") exports.generateFriendListByBabyStep = generateFriendListByBabyStep;

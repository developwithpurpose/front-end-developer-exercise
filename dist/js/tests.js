...
},{"../framework/view":8,"./navigation-item":14}],16:[function(require,module,exports){
'use strict';

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var _appAssetsJavascriptsFrameworkBase = require('../../app/assets/javascripts/framework/base');

var _appAssetsJavascriptsFrameworkBase2 = _interopRequireDefault(_appAssetsJavascriptsFrameworkBase);
...
describe('Module: framework/base', function () {
    ...
    beforeEach(function () {
        baseInstance = new _appAssetsJavascriptsFrameworkBase2['default']();
    });
    ...
    it('get() method gets a property from the data object', function () {
        baseInstance.set('aProperty', 'a value');
        var result = baseInstance.get('aProperty');

        expect(result).toEqual('a value');
    });

    it('listen() method adds a subscription that is triggered by the notify() method on the target', function () {
        var testEventCallback = jasmine.createSpy();
        var subscriber = baseInstance;
        var publisher = new _appAssetsJavascriptsFrameworkBase2['default']();
...
},{"../../app/assets/javascripts/framework/base":5}],17:[function(require,module,exports){
'use strict';

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var _appAssetsJavascriptsFrameworkCollection = require('../../app/assets/javascripts/framework/collection');

var _appAssetsJavascriptsFrameworkCollection2 = _interopRequireDefault(_appAssetsJavascriptsFrameworkCollection);

var _appAssetsJavascriptsFrameworkModel = require('../../app/assets/javascripts/framework/model');

var _appAssetsJavascriptsFrameworkModel2 = _interopRequireDefault(_appAssetsJavascriptsFrameworkModel);
...
describe('Module: framework/collection', function () {
    ...
    it('Models property is initialized to an empty array', function () {
        collectionInstance = new _appAssetsJavascriptsFrameworkCollection2['default']();

        expect(collectionInstance.models).toEqual([]);
    });

    it('push() method adds an model to the models array', function () {
        var testModel = new _appAssetsJavascriptsFrameworkModel2['default']({
            aProperty: 'a value'
        });
    ...
    it('push() method throws error when param is not a Model instance', function () {
        collectionInstance = new _appAssetsJavascriptsFrameworkCollection2['default']();
        var invalidPush = function invalidPush() {
    ...
    it('each() loops over the model array and executes a callback', function () {
        ...
        collectionInstance.push(new _appAssetsJavascriptsFrameworkModel2['default']({ id: 'item1' }));
        collectionInstance.push(new _appAssetsJavascriptsFrameworkModel2['default']({ id: 'item2' }));
        collectionInstance.push(new _appAssetsJavascriptsFrameworkModel2['default']({ id: 'item3' }));

        var returnValues = [];
        collectionInstance.each(function (item) {
    ...
    it('Filter returns a filtered array of models', function () {
        collectionInstance = new _appAssetsJavascriptsFrameworkCollection2['default']();
        collectionInstance.push(new _appAssetsJavascriptsFrameworkModel2['default']({ id: 1, name: 'foo' }));
        collectionInstance.push(new _appAssetsJavascriptsFrameworkModel2['default']({ id: 2, name: 'foo' }));
        collectionInstance.push(new _appAssetsJavascriptsFrameworkModel2['default']({ id: 3, name: 'bar' }));

        var filtered = collectionInstance.filter(function (element) {
...
},{"../../app/assets/javascripts/framework/collection":6,"../../app/assets/javascripts/framework/model":7}],18:[function(require,module,exports){
'use strict';
...
describe('Module: framework/model', function () {
    ...
    it('Exception is thrown when object is not passed to the constructor', function () {
        var initWithString = function initWithString() {
            modelInstance = new _appAssetsJavascriptsFrameworkModel2['default']('a string');
        };
    ...
    it('Object passed to the constructor is set on the data property', function () {
        ...
        modelInstance = new _appAssetsJavascriptsFrameworkModel2['default'](testObject);
...
},{"../../app/assets/javascripts/framework/model":7}],19:[function(require,module,exports){
"use strict";
